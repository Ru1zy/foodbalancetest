...
export const SITE_CONFIG = {
  ...
  url: getPublicAppUrl(),
  phone: process.env.NEXT_PUBLIC_CONTACT_PHONE?.trim() || "+380 93 015 05 07",
  phoneRaw: "+380930150507",
  phoneDisplay: process.env.NEXT_PUBLIC_CONTACT_PHONE?.trim() || "+380 93 015 05 07",
