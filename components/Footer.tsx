...
export default function Footer() {
  return (
    <footer className="bg-slate-50 dark:bg-slate-950 border-t border-gray-200 dark:border-slate-700">
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-12 grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
        ...
        <div>
          <h3 className="text-lg font-bold text-slate-800 dark:text-slate-200 mb-4">Умови замовлення</h3>
        ...
        <div>
          <h3 className="text-lg font-bold text-slate-800 dark:text-slate-200 mb-4">Графік доставки</h3>
          <p className="text-sm font-medium text-slate-800 dark:text-slate-200">Неділя - П&apos;ятниця: 17:00 - 21:30</p>
        ...
        {/* Column 3: Contacts */}
        <div>
          <h3 className="text-lg font-bold text-slate-800 dark:text-slate-200 mb-4">Контакти</h3>
          <div className="flex flex-col space-y-3 text-sm text-slate-600 dark:text-slate-400">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="border-t border-gray-200 dark:border-slate-700 py-6 mt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-500">
