export default function Loading() {
  return (
    <main className="min-h-[100dvh] bg-gray-50 dark:bg-slate-950 px-4 py-10 sm:px-6 md:px-8">
      <section className="mx-auto max-w-6xl animate-pulse">
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)]">
          <div className="rounded-[2rem] border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-6 shadow-sm sm:p-8">
