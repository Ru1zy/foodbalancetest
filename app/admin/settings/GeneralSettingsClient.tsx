    ...
    <div className="mx-auto max-w-4xl">
      ...
      <AdminHelpBanner
        ...
        items={[
          ...
          {
            icon: "📥",
            title: "Синхронізація клієнтів",
            text: "Кнопка 'Імпортувати клієнтів' переносить базу користувачів із робочої CRM Google Таблиці безпосередньо в базу даних сайту.",
          },
          {
            icon: "🤖",
            title: "Telegram Webhook",
            text: "Кнопка 'Оновити Webhook Telegram' миттєво перереєстровує адресу бота у разі збоїв зв'язку або зміни домену.",
          },
          {
            icon: "⚠️",
            title: "Очищення (Danger Zone)",
            text: "Блок у самому низу для очищення тестових замовлень або акаунтів перед запуском. Всі адміни з TELEGRAM_ADMIN_CHAT_ID захищені від видалення.",
          },
        ]}
        tips={[
          ...
          "Після будь-яких змін у формі контактів чи IBAN обов'язково натисніть кнопку 'Зберегти зміни' внизу.",
        ]}
      />
