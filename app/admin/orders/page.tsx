          ...
          items={[
            {
              ...
              text: "Перемикайте поточний стан замовлення: 'Нове', 'Оплачено', 'Готується' або 'Доставлено' прямо у випадаючому списку.",
            },
            {
              icon: "💳",
              title: "Контроль оплати",
              text: "Відображає спосіб розрахунку (онлайн Plata by mono, переказ за IBAN або готівка) та статус оплати.",
            },
            {
              icon: "📊",
            ...
            {
              icon: "💳",
              title: "Посилання на оплату Mono",
              text: "Кнопка '💳 Посилання Mono' створює рахунок Plata на узгоджену суму та автоматично пропонує об'єднати всі неоплачені раціони клієнта в один спільний чек.",
            },
            {
              icon: "🍱",
              title: "Деталізація меню",
              text: "Переглядайте обраний раціон, кілокалорії (включно зі Sport Active+), кількість днів доставки, прилади та всі дні розгорнуто.",
            },
            {
              icon: "🍳",
              title: "Швидкий експорт на кухню",
              text: "Панель 'Експорт на кухню' нижче дозволяє завантажити CSV або надіслати страви на будь-яку дату для виробничого цеху кухарів.",
            },
            {
              icon: "📦",
              title: "Архівування",
              text: "Кнопка 'Архівувати старі' переносить доставлені замовлення в архів. Щоночі о 05:00 це також робить автоматичний крон.",
            },
          ]}
          tips={[
            "Кнопка '💳 Посилання Mono' автоматично шукає всі неоплачені замовлення клієнта — зручно для формування одного рахунку за кілька раціонів.",
            "Якщо біля замовлення світиться жовте попередження про таблицю — перевірте розділ 'Таблиці' та активуйте конфігурацію на відповідний місяць.",
