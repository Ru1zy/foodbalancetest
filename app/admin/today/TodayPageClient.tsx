      ...
      <div className="mx-auto max-w-7xl">
        ...
        <AdminHelpBanner
          ...
          items={[
            ...
            {
              icon: "❌",
              title: "Скасування дня доставки",
              text: "Кнопка 'Скасувати' у рядку клієнта прибирає доставку на вибраний день і автоматично повертає цей день назад на баланс абонемента в CRM.",
            },
            {
              icon: "↔️",
          ...
          tips={[
            "Передача замовлень кухарям у Google Таблиці відбувається автоматично 24/7 у момент оформлення, натискати кнопки для синхронізації кухні не потрібно.",
