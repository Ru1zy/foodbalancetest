        ...
        <AdminHelpBanner
          ...
          items={[
            ...
            },
            {
              icon: "💬",
              title: "Ціна (текст)",
              text: "Маркетинговий напис на картці тарифу (наприклад: 'від 520 грн/день') для привабливого вигляду у каталозі.",
            },
            {
              icon: "💰",
              title: "Базова ціна",
              text: "Числове значення вартості одного дня в гривнях, що використовується калькулятором кошика при розрахунку суми.",
            },
            {
              icon: "🖼️",
